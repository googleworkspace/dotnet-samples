...
/**
 * \mainpage
 *   Drive API Version v3beta
 *
 * \section ApiInfo API Version Information
 *    <table>
 *      <tr><th>API
 *          <td><a href='https://developers.google.com/drive/'>Drive API</a>
 *      <tr><th>API Version<td>v3beta
 *      <tr><th>API Rev<td>0
 *      <tr><th>API Docs
 *          <td><a href='https://developers.google.com/drive/'>
 *              https://developers.google.com/drive/</a>
 *      <tr><th>Discovery Name<td>drive
 *      <tr><th>Generated At<td>2017-10-12 17:09:47 UTC
...
namespace Google.Apis.Drive.v3beta.Data
{
...
namespace Google.Apis.Drive.v3beta
{
    ...
    public class DriveService : Google.Apis.Services.BaseClientService
    {
        ...
        {
            get { return "https://www.googleapis.com/drive/v3beta/"; }
        }

        /// <summary>Gets the service base path.</summary>
        public override string BasePath
        {
            get { return "drive/v3beta/"; }
        }
    ...
    public class AboutResource
    {
        ...
        /// <summary>Gets information about the user, the user's Drive, and system capabilities.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.About>
        {
    ...
    public class ChangesResource
    {
        ...
        /// <summary>Gets the starting pageToken for listing future changes.</summary>
        public class GetStartPageTokenRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.StartPageToken>
        {
        ...
        /// <summary>Lists the changes for a user or Team Drive.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.ChangeList>
        {
        ...
        /// value of 'nextPageToken' from the previous response or to the response from the getStartPageToken
        /// method.</param>
        public virtual WatchRequest Watch(Google.Apis.Drive.v3beta.Data.Channel body, string pageToken)
        {
            return new WatchRequest(service, body, pageToken);
        }

        /// <summary>Subscribes to changes for a user.</summary>
        public class WatchRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Channel>
        {
            /// <summary>Constructs a new Watch request.</summary>
            public WatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Channel body, string pageToken)
                : base(service)
            {
                PageToken = pageToken;
                Body = body;
            ...
            Google.Apis.Drive.v3beta.Data.Channel Body { get; set; }
    ...
    public class ChannelsResource
    {
        ...
        /// <param name="body">The body of the request.</param>
        public virtual StopRequest Stop(Google.Apis.Drive.v3beta.Data.Channel body)
        {
        ...
        public class StopRequest : DriveBaseServiceRequest<string>
        {
            ...
            public StopRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Channel body)
                : base(service)
            {
                Body = body;
                InitParameters();
    ...
    public class CommentsResource
    {
        ...
        public virtual CreateRequest Create(Google.Apis.Drive.v3beta.Data.Comment body, string fileId)
        {
            return new CreateRequest(service, body, fileId);
        }

        /// <summary>Creates a new comment on a file.</summary>
        public class CreateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Comment>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Comment body, string fileId)
                : base(service)
            {
                FileId = fileId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Drive.v3beta.Data.Comment Body { get; set; }
        ...
        /// <summary>Gets a comment by ID.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Comment>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists a file's comments.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.CommentList>
        {
            /// <summary>Constructs a new List request.</summary>
        ...
        /// <param name="fileId">The ID of the file.</param>
        /// <param name="commentId">The ID of the comment.</param>
        public virtual UpdateRequest Update(Google.Apis.Drive.v3beta.Data.Comment body, string fileId, string commentId)
        {
            return new UpdateRequest(service, body, fileId, commentId);
        }

        /// <summary>Updates a comment with patch semantics.</summary>
        public class UpdateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Comment>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Comment body, string fileId, string commentId)
                : base(service)
            {
                FileId = fileId;
                CommentId = commentId;
    ...
    public class FilesResource
    {
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="fileId">The ID of the file.</param>
        public virtual CopyRequest Copy(Google.Apis.Drive.v3beta.Data.File body, string fileId)
        {
            return new CopyRequest(service, body, fileId);
        }

        /// <summary>Creates a copy of a file and applies any requested updates with patch semantics.</summary>
        public class CopyRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.File>
        {
            /// <summary>Constructs a new Copy request.</summary>
            public CopyRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.File body, string fileId)
                : base(service)
            {
                FileId = fileId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Drive.v3beta.Data.File Body { get; set; }
        ...
        /// <param name="body">The body of the request.</param>
        public virtual CreateRequest Create(Google.Apis.Drive.v3beta.Data.File body)
        {
            return new CreateRequest(service, body);
        }

        /// <summary>Creates a new file.</summary>
        public class CreateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.File>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.File body)
                : base(service)
            {
                Body = body;
                InitParameters();
        ...
        public virtual CreateMediaUpload Create(Google.Apis.Drive.v3beta.Data.File body, System.IO.Stream stream, string contentType)
        {
        ...
        public class CreateMediaUpload : Google.Apis.Upload.ResumableUpload<Google.Apis.Drive.v3beta.Data.File, Google.Apis.Drive.v3beta.Data.File>
        {
            ...
            public CreateMediaUpload(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.File body, System.IO.Stream stream, string contentType)
        ...
        /// <summary>Generates a set of file IDs which can be provided in create requests.</summary>
        public class GenerateIdsRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.GeneratedIds>
        {
        ...
        /// <summary>Gets a file's metadata or content by ID.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.File>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists or searches files.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.FileList>
        {
            /// <summary>Constructs a new List request.</summary>
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="fileId">The ID of the file.</param>
        public virtual UpdateRequest Update(Google.Apis.Drive.v3beta.Data.File body, string fileId)
        {
            return new UpdateRequest(service, body, fileId);
        }

        /// <summary>Updates a file's metadata and/or content with patch semantics.</summary>
        public class UpdateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.File>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.File body, string fileId)
                : base(service)
            {
                FileId = fileId;
                Body = body;
        ...
        /// <param name="stream">The stream to upload.</param>
        /// <param name="contentType">The content type of the stream to upload.</param>
        public virtual UpdateMediaUpload Update(Google.Apis.Drive.v3beta.Data.File body, string fileId, System.IO.Stream stream, string contentType)
        {
        ...
        public class UpdateMediaUpload : Google.Apis.Upload.ResumableUpload<Google.Apis.Drive.v3beta.Data.File, Google.Apis.Drive.v3beta.Data.File>
        {
            ...
            public UpdateMediaUpload(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.File body, string
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="fileId">The ID of the file.</param>
        public virtual WatchRequest Watch(Google.Apis.Drive.v3beta.Data.Channel body, string fileId)
        {
        ...
        {
            /// <summary>Constructs a new Watch request.</summary>
            public WatchRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Channel body, string fileId)
                : base(service)
            {
                FileId = fileId;
                Body = body;
    ...
    public class PermissionsResource
    {
        ...
        public virtual CreateRequest Create(Google.Apis.Drive.v3beta.Data.Permission body, string fileId)
        {
            return new CreateRequest(service, body, fileId);
        }

        /// <summary>Creates a permission for a file or Team Drive.</summary>
        public class CreateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Permission>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Permission body, string fileId)
                : base(service)
            {
                FileId = fileId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Drive.v3beta.Data.Permission Body { get; set; }
        ...
        /// <summary>Gets a permission by ID.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Permission>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists a file's or Team Drive's permissions.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.PermissionList>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string fileId)
                : base(service)
        ...
        /// <param name="permissionId">The ID of the
        /// permission.</param>
        public virtual UpdateRequest Update(Google.Apis.Drive.v3beta.Data.Permission body, string fileId, string permissionId)
        {
            return new UpdateRequest(service, body, fileId, permissionId);
        }

        /// <summary>Updates a permission with patch semantics.</summary>
        public class UpdateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Permission>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Permission body, string fileId, string permissionId)
                : base(service)
            {
                FileId = fileId;
                PermissionId = permissionId;
    ...
    public class RepliesResource
    {
        ...
        /// <param name="fileId">The ID of the file.</param>
        /// <param name="commentId">The ID of the comment.</param>
        public virtual CreateRequest Create(Google.Apis.Drive.v3beta.Data.Reply body, string fileId, string commentId)
        {
            return new CreateRequest(service, body, fileId, commentId);
        }

        /// <summary>Creates a new reply to a comment.</summary>
        public class CreateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Reply>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Reply body, string fileId, string commentId)
                : base(service)
            {
                FileId = fileId;
                CommentId = commentId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Drive.v3beta.Data.Reply Body { get; set; }
        ...
        /// <summary>Gets a reply by ID.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Reply>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists a comment's replies.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.ReplyList>
        {
            /// <summary>Constructs a new List request.</summary>
        ...
        /// comment.</param>
        /// <param name="replyId">The ID of the reply.</param>
        public virtual UpdateRequest Update(Google.Apis.Drive.v3beta.Data.Reply body, string fileId, string commentId, string replyId)
        {
            return new UpdateRequest(service, body, fileId, commentId, replyId);
        }

        /// <summary>Updates a reply with patch semantics.</summary>
        public class UpdateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Reply>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Reply body, string fileId, string commentId, string replyId)
                : base(service)
            {
                FileId = fileId;
                CommentId = commentId;
    ...
    public class RevisionsResource
    {
        ...
        /// <summary>Gets a revision's metadata or content by ID.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Revision>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists a file's revisions.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.RevisionList>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service, string fileId)
                : base(service)
        ...
        /// <param name="revisionId">The ID of the
        /// revision.</param>
        public virtual UpdateRequest Update(Google.Apis.Drive.v3beta.Data.Revision body, string fileId, string revisionId)
        {
            return new UpdateRequest(service, body, fileId, revisionId);
        }

        /// <summary>Updates a revision with patch semantics.</summary>
        public class UpdateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.Revision>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.Revision body, string fileId, string revisionId)
                : base(service)
            {
                FileId = fileId;
                RevisionId = revisionId;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Drive.v3beta.Data.Revision Body { get; set; }
    ...
    public class TeamdrivesResource
    {
        ...
        /// returned.</param>
        public virtual CreateRequest Create(Google.Apis.Drive.v3beta.Data.TeamDrive body, string requestId)
        {
            return new CreateRequest(service, body, requestId);
        }

        /// <summary>Creates a new Team Drive.</summary>
        public class CreateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.TeamDrive>
        {
            /// <summary>Constructs a new Create request.</summary>
            public CreateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.TeamDrive body, string requestId)
                : base(service)
            {
                RequestId = requestId;
                Body = body;
            ...
            /// <summary>Gets or sets the body of this request.</summary>
            Google.Apis.Drive.v3beta.Data.TeamDrive Body { get; set; }
        ...
        /// <summary>Gets a Team Drive's metadata by ID.</summary>
        public class GetRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.TeamDrive>
        {
            /// <summary>Constructs a new Get request.</summary>
        ...
        /// <summary>Lists the user's Team Drives.</summary>
        public class ListRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.TeamDriveList>
        {
            /// <summary>Constructs a new List request.</summary>
            public ListRequest(Google.Apis.Services.IClientService service)
                : base(service)
        ...
        /// <param name="body">The body of the request.</param>
        /// <param name="teamDriveId">The ID of the Team Drive</param>
        public virtual UpdateRequest Update(Google.Apis.Drive.v3beta.Data.TeamDrive body, string teamDriveId)
        {
            return new UpdateRequest(service, body, teamDriveId);
        }

        /// <summary>Updates a Team Drive's metadata</summary>
        public class UpdateRequest : DriveBaseServiceRequest<Google.Apis.Drive.v3beta.Data.TeamDrive>
        {
            /// <summary>Constructs a new Update request.</summary>
            public UpdateRequest(Google.Apis.Services.IClientService service, Google.Apis.Drive.v3beta.Data.TeamDrive body, string teamDriveId)
                : base(service)
            {
                TeamDriveId = teamDriveId;
                Body = body;
